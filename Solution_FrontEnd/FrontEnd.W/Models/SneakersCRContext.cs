        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Productos>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCategoriaNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__productos__id_ca__3F115E1A");

                entity.HasOne(d => d.IdMarcaProductoNavigation)
                    .WithMany(p => p.Productos)
                    .HasForeignKey(d => d.IdMarcaProducto)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__productos__id_ma__2645B050");
            ...
            modelBuilder.Entity<TelefonoTienda>(entity =>
            {
                ...
                entity.HasOne(d => d.IdTiendaNavigation)
                    ...
                    .HasForeignKey(d => d.IdTienda)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__telefono___id_ti__282DF8C2");
            });
            ...
            modelBuilder.Entity<UbicacionTienda>(entity =>
            {
                ...
                entity.HasOne(d => d.IdTiendaNavigation)
                    ...
                    .HasForeignKey(d => d.IdTienda)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ubicacion__id_ti__29221CFB");
            });
            ...
            modelBuilder.Entity<UsuarioTienda>(entity =>
            {
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__usuario_t__id_us__44CA3770");
            });
            ...
            modelBuilder.Entity<ValoracionTienda>(entity =>
            {
                ...
                entity.HasOne(d => d.IdTiendaNavigation)
                    ...
                    .HasForeignKey(d => d.IdTienda)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__valoracio__id_ti__45BE5BA9");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.ValoracionTienda)
                    .HasForeignKey(d => d.IdUsuario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__valoracio__id_us__2CF2ADDF");
            });
